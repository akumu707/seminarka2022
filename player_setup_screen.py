...
class PlayerSetupScreen:
    def __init__(self, screen_options, ui_manager, game_settings, background_surface):
        ...
        self.content = [[self.welcome_text], [self.name_text, self.player_name_input, self.player_name_submit],
                        [self.surname_text, self.player_surname_input, self.player_surname_submit], [self.next_button]]
        self.hide()
